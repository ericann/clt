...
public class AccessPermissionsListener {
	...
	@RequestMapping(value="/accesstoken/verify/code", method=RequestMethod.POST)
	public @ResponseBody String getVerifyCode(@RequestBody String address) {
		return JSONObject.valueToString(this.accessService.bindWehcatWithEmailCode(address));
	}
